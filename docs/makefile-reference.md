...
The Nebari Operator uses a Makefile generated by Kubebuilder that provides convenient commands for development, testing,
...
**Used in CI**:
- ✅ PR builds ([.github/workflows/build-pr.yml](../.github/workflows/build-pr.yml))
