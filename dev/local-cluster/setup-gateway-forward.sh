...
# This allows accessing services via localhost:80/443 on macOS
...
echo ""
log_info "You can now access services via localhost:"
echo "  - HTTP:  http://localhost (or http://your-app.nic.local)"
echo "  - HTTPS: https://localhost (or https://your-app.nic.local)"
echo ""
log_info "Add entries to /etc/hosts:"
echo "  127.0.0.1  nginx-demo.nic.local"
echo ""
log_info "Then access: http://nginx-demo.nic.local"
echo ""
log_warning "Note: This forwarding is lost when the cluster is deleted/restarted"
